...
Public Class Eoitb : Inherits DIAPI

#Region "Campos de control"
    Public Property Atributo As SAPbobsCOM.ItemGroups
    Private moCompany As Company
    Private moObjeto As SAPbobsCOM.ItemGroups
...
#End Region
    ...
    Public Sub New()
        ...
        moObjeto = CType(moCompany.GetBusinessObject(BoObjectTypes.oItemGroups), SAPbobsCOM.ItemGroups)
        Atributo = moObjeto
    End Sub
