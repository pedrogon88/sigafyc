...
Public Class Eoslp : Inherits DIAPI

#Region "Campos de control"
    Public Property Atributo As SAPbobsCOM.SalesPersons
    Private moCompany As Company
    Private moObjeto As SAPbobsCOM.SalesPersons
...
#End Region
    ...
    Public Sub New()
        ...
        moObjeto = CType(moCompany.GetBusinessObject(BoObjectTypes.oSalesPersons), SAPbobsCOM.SalesPersons)
        Atributo = moObjeto
    End Sub
    ...
    Public Function Add() As String
        ...
        Catch ex As Exception
            lsRespuesta = "Ocurrió un error al intentar crear el articulo. Motivo: " & ex.Message
        End Try
        Return lsRespuesta
    End Function
    ...
    Public Function Put() As String
        ...
        Try
            ...
            If liRespuesta <> 0 Then
                lsRespuesta = "Ocurrió un error al intetar ACTUALIZAR el articulo. Motivo: " & moCompany.GetLastErrorDescription
            End If
        Catch ex As Exception
