...
Public Class Eoitm : Inherits DIAPI

#Region "Campos de control"
    Public Property Atributo As SAPbobsCOM.Items
    Private moCompany As Company
    Private moObjeto As SAPbobsCOM.Items
...
#End Region
    ...
    Public Sub New()
        ...
        moObjeto = CType(moCompany.GetBusinessObject(BoObjectTypes.oItems), SAPbobsCOM.Items)
        Atributo = moObjeto
    End Sub
