        ...
        Select Case Me.Tag.ToString
            Case sAGREGAR_
                For liNDX As Integer = 0 To loControls.Count - 1
                    ...
                    End If
                Next
                txtSS010_codigo_AN.Text = CType(entidad, Ess030tabcab).ss010_codigo
            Case Else
                Dim loDatos As New Ess030tabcab
                loDatos.ss010_codigo = CType(entidad, Ess030tabcab).ss010_codigo
                loDatos.codigo = CType(entidad, Ess030tabcab).codigo
                If loDatos.GetPK() = sOk_ Then
