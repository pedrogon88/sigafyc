...
Public Class frmFss020modulos
    Private msValidado As String = ""
    Private msRequeridos As String() = {"codigo", "nombre", "tipo", "descripcion"}
        ...
        Select Case Me.Tag.ToString
            Case sAGREGAR_
                For liNDX As Integer = 0 To loControls.Count - 1
                    ...
                    End If
                Next
                txtSS010_codigo_AN.Text = CType(entidad, Ess020modulos).ss010_codigo
            Case Else
                Dim loDatos As New Ess020modulos
                loDatos.ss010_codigo = CType(entidad, Ess020modulos).ss010_codigo
                loDatos.codigo = CType(entidad, Ess020modulos).codigo
                If loDatos.GetPK() = sOk_ Then
                    txtSS010_codigo_AN.Text = loDatos.ss010_codigo
                    txtCodigo_AN.Text = loDatos.codigo
                    txtNombre_AN.Text = loDatos.nombre
                    txtDescripcion_AN.Text = loDatos.descripcion
    ...
    Private Sub LPInicializaMaxLength()
        ...
        txtCodigo_AN.MaxLength = 24
        txtNombre_AN.MaxLength = 60
        txtDescripcion_AN.MaxLength = 120
