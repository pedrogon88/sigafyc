...
Public Class frmFss040tabdet
    Private msValidado As String = ""
    Private msRequeridos As String() = {"codigo", "nombre", "detalle", "estado"}
            ...
            Else
                Select Case Me.Tag.ToString
                    Case sAGREGAR_
                        ...
                        loDatos.ss030_codigo = txtSS030_codigo_AN.Text
                        loDatos.codigo = txtCodigo_AN.Text
                        loDatos.nombre = txtNombre_AN.Text
                        loDatos.detalle = txtDetalle_AN.Text
    ...
    Private Sub ManejoEvento_Validating(sender As Object, e As CancelEventArgs)
        ...
        Else
            Select Case CType(sender, Control).AccessibleName
                Case "codigo"
                    Dim loPk As New Ess040tabdet
                    loPk.ss010_codigo = txtSS010_codigo_AN.Text
                    loPk.ss030_codigo = txtSS030_codigo_AN.Text
    ...
    Private Sub Formulario_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        msEntidad = "registro detalle de tabla"
        DesplegarMensaje()
        ...
        Select Case Me.Tag.ToString
            Case sAGREGAR_
                For liNDX As Integer = 0 To loControls.Count - 1
                    ...
                    End If
                Next
                txtSS010_codigo_AN.Text = CType(entidad, Ess040tabdet).ss010_codigo
                txtSS030_codigo_AN.Text = CType(entidad, Ess040tabdet).ss030_codigo
            Case Else
                Dim loDatos As New Ess040tabdet
                loDatos.ss010_codigo = CType(entidad, Ess040tabdet).ss010_codigo
                loDatos.ss030_codigo = CType(entidad, Ess040tabdet).ss030_codigo
                loDatos.codigo = CType(entidad, Ess040tabdet).codigo
                If loDatos.GetPK() = sOk_ Then
                    txtSS010_codigo_AN.Text = loDatos.ss010_codigo
                    txtSS030_codigo_AN.Text = loDatos.ss030_codigo
                    txtCodigo_AN.Text = loDatos.codigo
                    txtNombre_AN.Text = loDatos.nombre
                    txtDetalle_AN.Text = loDatos.detalle
    ...
    Private Sub LPInicializaMaxLength()
        ...
        txtSS010_codigo_AN.MaxLength = 128
        txtCodigo_AN.MaxLength = 128
        txtNombre_AN.MaxLength = 256
        txtDetalle_AN.MaxLength = 32000
    End Sub
