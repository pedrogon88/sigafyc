...
Public Class frmFReaperturaEjercicio
    ...
    Private Sub txtCodSucursal_NE_Validating(sender As Object, e As CancelEventArgs) Handles txtCodSucursal_NE.Validating
        ...
        End If
        LPDespliegaDescripciones()
        Dim liCantidad As Integer = GFiVerificaCantidadMovimientos(liCodEmpresa, liCodSucursal, msPeriodoInicio, msPeriodoFinal)
        If liCantidad > 0 Then
            GFsAvisar("La Empresa:" & lblNombreEmpresa.Text.Trim & ", Sucursal:" & lblNombreSucursal.Text.Trim & ", en el ejercicio en curso tiene movimientos", sMENSAJE_, "La REAPERTURA implica que este seria el primer asiento del ejercicio. No se puede realizar el proceso solicitado.")
            e.Cancel = True
            Exit Sub
        End If
    End Sub
    ...
    Private Sub btnAceptar_Click(sender As Object, e As EventArgs) Handles btnAceptar.Click
        ...
        If InStr(msValidado, sCancelar_) > 0 Then
            ...
            Exit Sub
        End If
        If GFsConfirmacion(sMENSAJE_, "Esta a punto de generar los asientos de Reapertura del Ejercicio, para la Empresa:" & lblNombreEmpresa.Text & ", Sucursal:" & lblNombreSucursal.Text & ", con el Documento:" & lblNombreDocumento.Text) = sOk_ Then
    ...
    Private Sub LPProcesaParametros()
        ...
        Dim liCodDocumento As Integer = Integer.Parse(txtCodDocumento_NE.Text.ToString)
        If liCodSucursal = 0 Then
            Dim lsSQL As String = GFsGeneraSQL("frmFReaperturaEjercicio_Sucursales")
            ...
            While loDataReader.Read
                ...
                GPReaperturaEjercicio(liCodEmpresa, liCodSucursal, liCodDocumento)
            End While
            loDataReader.Close()
