Public Class frmBoitmc1
    ...
    Private Sub LPCargarDatos()
        ...
        Dim lsCampos As String = "itemcode, fechademanda, fechaordensecuestro, fechasecuestro, valortasacion, fecharemate, gastoventa, precioventa"
        Dim lsCamposConcat As String = "itemcode, fechademanda"
    ...
    Private Sub LPLocalizaRegistro(ByVal psCodigo As String)
        ...
        For Each row As DataGridViewRow In DataGridView1.Rows
            If row.Cells("itemcode").Value.ToString = psCodigo Then
    ...
    Private Sub Botones_Click(sender As Object, e As EventArgs)
        ...
        Select Case CType(sender, Button).AccessibleName
            ...
            Case Else
                ...
                '---------------------------------------------------------------------------------------------
                Dim lsCodigo As String = DataGridView1.Item("itemcode", DataGridView1.CurrentRow.Index).Value.ToString
