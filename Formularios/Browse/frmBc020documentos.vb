...
Public Class frmBc020documentos
    ...
    Private Sub LPCargarDatos()
        ...
        Dim lsCampos As String = "coddocumento as codigo, tipo, abreviado, nombre, timbrado, codmoneda, cotizacion, lineas, estado, codempresa"
        Dim lsCamposConcat As String = "coddocumento, tipo, abreviado, nombre, timbrado, codmoneda, cotizacion, lineas, estado"
