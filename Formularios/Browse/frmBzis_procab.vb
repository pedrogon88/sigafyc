Public Class frmBzis_procab
    Private moFormulario As frmFzis_procab
    ...
    Private Sub LPCargarDatos()
        ...
        Dim lsCampos As String = "numtra, abreviado, formproc, tipexec, tipact, undtmp, tiempo, start, ending"
    ...
    Private Sub Botones_Click(sender As Object, e As EventArgs)
        ...
        Select Case CType(sender, Button).AccessibleName
            Case sAGREGAR_
                moFormulario = New frmFzis_procab
    ...
    Private Sub btnDetalle_MouseLeave(sender As Object, e As EventArgs) Handles btnDetalle.MouseLeave
        btnDetalle.Image = My.Resources.Resources.icons8_details_32
        btnDetalle.Text = btnDetalle.Tag.ToString
    End Sub

    Private Sub btnDetalle_Click(sender As Object, e As EventArgs) Handles btnDetalle.Click
        Dim loBrowseDetalle As New frmBzis_prodet
    ...
    Private Sub ProcesarManualmenteToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ProcesarManualmenteToolStripMenuItem.Click
        Dim loZIS_PROCAB As New Ezis_procab
        loZIS_PROCAB.numtra = CInt(DataGridView1.Item("numtra", DataGridView1.CurrentRow.Index).Value.ToString)
        If loZIS_PROCAB.GetPK = sOk_ Then
            Dim loProcesar As New frmFzis_procesar_procab
            loProcesar.NumTra = loZIS_PROCAB.numtra
            GPCargar(loProcesar)
        End If
    End Sub
End Class